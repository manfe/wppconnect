...
var playwright_browser_1 = require("./playwright-browser");
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [3 /*break*/, 8];
                case 3:
                    if (!(!browser && !page)) return [3 /*break*/, 8];
                    ...
                    if (!mergedOptions.usePlaywright) return [3 /*break*/, 5];
                    logger.info('Initializing Playwright browser...', {
                        session: session,
                        type: 'playwright-browser',
                    });
                    return [4 /*yield*/, (0, playwright_browser_1.initPlaywrightBrowser)(session, mergedOptions, logger).catch(function (e) {
                ...
                case 8:
                    ...
                    if (!mergedOptions.usePlaywright) return [3 /*break*/, 10];
                    return [4 /*yield*/, (0, playwright_browser_1.getOrCreatePagePlaywright)(browser)];
                case 9:
                    page = (_b.sent());
                    return [3 /*break*/, 12];
                case 10: return [4 /*yield*/, (0, browser_1.getOrCreatePage)(browser)];
                case 11:
                    // Default to Puppeteer
                    page = _b.sent();
                    _b.label = 12;
                case 12:
                    ...
                    if (!mergedOptions.useChrome) return [3 /*break*/, 14];
                ...
                case 15:
                    _b.sent();
                    if (!mergedOptions.waitForLogin) return [3 /*break*/, 17];
                ...
                case 16:
                    ...
                    _b.label = 17;
                case 17: return [2 /*return*/, client_1];
