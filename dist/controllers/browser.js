        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, page.evaluateOnNewDocument(function () {
                        ...
                        var dumpRegistrations = function (label) {
                            return sw
                                .getRegistrations()
                                .then(function (registrations) {
                                var payload = registrations.map(function (registration) {
                                    var toUrl = function (worker) {
                                        return (worker === null || worker === void 0 ? void 0 : worker.scriptURL) || null;
                                    };
                                    return {
                        ...
                        sw.register = function () {
                            ...
                            return originalRegister.apply(void 0, args).then(function (registration) {
                                var _a, _b, _c;
                                console.log('[sw-trace] register resolved', {
                                    scope: registration.scope,
                                    active: ((_a = registration.active) === null || _a === void 0 ? void 0 : _a.scriptURL) || null,
                                    waiting: ((_b = registration.waiting) === null || _b === void 0 ? void 0 : _b.scriptURL) || null,
                                    installing: ((_c = registration.installing) === null || _c === void 0 ? void 0 : _c.scriptURL) || null,
                                });
                        ...
                        sw.ready
                            .then(function () { return dumpRegistrations('ready'); })
                            .catch(function (error) {
