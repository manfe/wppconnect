...
var playwright_browser_1 = require("../../controllers/playwright-browser");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        this.isInjected = false;
                        injectionPromise = this.options.usePlaywright
                            ? (0, playwright_browser_1.injectApiPlaywright)(this.page, this.onLoadingScreen)
                            : (0, browser_1.injectApi)(this.page, this.onLoadingScreen);
                        return [4 /*yield*/, injectionPromise
                                .then(function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.isStarted = true;
                        if (!this.options.usePlaywright) return [3 /*break*/, 2];
                        return [4 /*yield*/, (0, playwright_browser_1.initWhatsappPlaywright)(this.page, null, false, this.options.whatsappVersion, this.options.proxy, this.log.bind(this))];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2: 
                    ...
                    case 3:
                        ...
                        _a.sent();
                        _a.label = 4;
                    case 4: return [4 /*yield*/, this.page.exposeFunction('checkQrCode', function () { return _this.checkQrCode(); })];
                    case 5:
                        _a.sent();
