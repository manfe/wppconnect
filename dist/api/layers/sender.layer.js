...
var SenderLayer = /** @class */ (function (_super) {
     ...
     */
    SenderLayer.prototype.sendFileFromUrl = function (to, url, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, (0, helpers_1.evaluateAndReturn)(this.page, function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                        var result;
                        var _c;
                        var to = _b.to, url = _b.url, options = _b.options;
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                case 0: return [4 /*yield*/, WPP.chat.sendFileMessage(to, url, __assign({}, options))];
                                case 1:
                                    result = _d.sent();
                                    _c = {
                                        ack: result.ack,
